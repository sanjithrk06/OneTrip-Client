                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className=" flex flex-col md:flex-row gap-4">
                      ...
                      <div className=" w-full md:w-1/2 space-y-1">
                        ...
                        <input
                          ...
                          className="block bg-white w-full rounded-lg outline-none border px-4 py-2 leading-6 text-slate-700 placeholder-gray-400 focus:ring-2 focus:ring-primary/50 border-gray-200 focus:border-primary"
                        />
                      </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className={`block bg-white w-full rounded-lg outline-none border px-4 py-2 leading-6 text-slate-700 placeholder-gray-400 focus:ring-2 focus:ring-primary/50 ${
                          isEmailValid
